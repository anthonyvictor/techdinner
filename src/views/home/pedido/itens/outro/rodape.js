...
export const Rodape = () => {
    ...
    function openContextMenuObservacoes(){
      ...
      function addSabor(){
          ...
          contextMenu([
            {title: 'Calabresa', click: () => ss('CALABRESA')},
            {title: 'Carne', click: () => ss('CARNE')},
            {title: 'Frango', click: () => ss('FRANGO')},
            {title: 'Presunto', click: () => ss('PRESUNTO')},
            {title: 'Hot Dog', click: () => ss('HOT DOG')},
            {title: 'Frango-Presunto', click: () => ss('FRANGO C/ PRESUNTO')},
            {title: 'Frango-Calabresa', click: () => ss('FRANGO C/ CALABRESA')},
            {title: 'Calabresa-Presunto', click: () => ss('CALABRESA C/ PRESUNTO')},
            {title: 'Queijo-Presunto', click: () => ss('QUEIJO C/ PRESUNTO')},
          ])
        
          const ss = (t) => setObservacoes(prev => join([prev, `SABOR ${t}`], ', '))
      }
        ...
        <Container>
            <div className='middle'>
                    ...
                    <div className='qtd'>
                      ...
                      value={qtd ?? 1} disabled={!!item?.outro}
